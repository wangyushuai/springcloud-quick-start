//package com.example.springcloud.util.redis;
//
...
//     */
//    //private static final String POINT_CUT = "execution(* com.example.springboot.com.example.springcloud.util.redis.RedisClient.*(..))";
//
